...
CGO_CFLAGS += -DMDBX_FORCE_ASSERTIONS=1 # Enable MDBX's asserts by default in 'main' branch and disable in releases
CGO_CFLAGS += -DMDBX_DISABLE_VALIDATION=0 # This feature is not ready yet
...
GO_FLAGS += -trimpath -tags $(BUILD_TAGS) -buildvcs=false -gcflags=all="-N -l"
